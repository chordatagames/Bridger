...
public static class ScriptableObjectUtil
{
	...
	{
		AssetDatabase.CreateAsset (AssetPreview.GetMiniThumbnail(Selection.activeObject), AssetDatabase.GenerateUniqueAssetPath(AssetDatabase.GetAssetPath (Selection.activeObject) + "/New"));
